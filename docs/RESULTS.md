...
- 실험 일자: 2026-09-15, CI run [34924158058](https://github.com/csungq-eng/doppler_sim/actions/runs/34924158058)
...
**N에 따른 RSRP 오차 (t = 1 ms, 60 km/h)** — 원본 [img/nmse_sweep_geo_v60.csv](img/nmse_sweep_geo_v60.csv)

| N (방식 2) | NMSE | RSRP 전대역 | RSRP 협대역 |
|---|---|---|---|
| 1 | −4.06 | 2.47 | 2.59 |
| 2 | −5.81 | 1.50 | 1.71 |
| 3 | −7.39 | 0.97 | 1.22 |
